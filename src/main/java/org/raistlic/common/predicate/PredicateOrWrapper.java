...
/**
 * A wrapper class that wraps two {@link Predicate} instances, and returns {@code true} as long as
 * any one of the tests passes.
 */
public final class PredicateOrWrapper<E> implements Predicate<E> {
